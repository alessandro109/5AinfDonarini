<html>
    ...
    <body>
        ...
        <div class="principale">
            ...
            $wsdl_url = "http://127.0.0.1/ConvertitoreSoldi/server/test.wsdl";

            if ((isset($_POST['Valore']) && !empty($_POST['Valore'])&& isset($_POST['Valuta']) && !empty($_POST['Valuta']))){ 

                try {

                    $client = new SoapClient($wsdl_url,["location" =>"http://127.0.0.1/ConvertitoreSoldi/server/",'uri' => "urn:servizioConverti"]);
